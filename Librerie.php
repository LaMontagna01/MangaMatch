<?php
    ...
    $q = "SELECT nome, tipologia FROM libreria WHERE id_utente = ?";
    $stmt = $conn->prepare($q);
...
<body>
    ...
    <form action="gestoreLibrerie.php" method="POST">
        <input type="hidden" name="id_manga" value="<?php echo htmlspecialchars($manga['id_manga']); ?>">
        <input type="hidden" name="titolo_manga" value="<?php echo htmlspecialchars($manga['titolo_manga']); ?>">
        <input type="hidden" name="autore_manga" value="<?php echo htmlspecialchars($manga['autore_manga']); ?>">
        <input type="hidden" name="descrizione_manga" value="<?php echo htmlspecialchars($manga['descrizione_manga']); ?>">
        <input type="hidden" name="volumi_manga" value="<?php echo htmlspecialchars($manga['volumi_manga']); ?>">
        <input type="hidden" name="capitoli_manga" value="<?php echo htmlspecialchars($manga['capitoli_manga']); ?>">
        <input type="hidden" name="rating_manga" value="<?php echo htmlspecialchars($manga['rating_manga']); ?>">
        <input type="hidden" name="immagine_manga" value="<?php echo htmlspecialchars($manga['immagine_manga']); ?>">
        ...
        <div id="selezionaLibreriaForm" style="display: none;">
            ...
            <select name="libreria" id="libreria" required>
                <option value="" selected>-- Seleziona una libreria --</option>
                    <?php 
                        while ($row = $librerie_utente->fetch_assoc()) {
                            ...
                            echo "<option value=\"$id\">$nome ($tipologia)</option>";
                        }
                    ?>
            </select>
        </div>
